...
class FormDesign
{
    ...
    //富文本上传地址
    private string $UploadUrl = 'https://www.example.com/upload';

    //图片上传地址
    private string $ImageUploadUrl = 'https://www.example.com/image_upload';

    //文件上传地址
    private string $FileUploadUrl = 'https://www.example.com/file_upload';
...
//                unset($item[$property]);
    ...
    protected function upload_url($value, $data): string
    {
        switch ($data['type']) {
            case 'image':
                $value = $value ?: $this->ImageUploadUrl;
                break;
            case 'file':
                $value = $value ?: $this->FileUploadUrl;
                break;
            case 'rich_text':
                $value = $value ?: $this->UploadUrl;
                break;
        }
        return $value;
    }
