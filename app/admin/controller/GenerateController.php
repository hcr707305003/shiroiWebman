...
class GenerateController extends AdminBaseController
{
    ...
    public function create(Request $request): Response
    {
        ...
        try {
            ...
            $n = "\n";
            Log::warning('生成报错：' . $n . '错误信息：' . $e->getMessage()
                . $n . '行数：' . $e->getLine()
                . $n . '文件：' . $e->getFile());
            $msg = '生成报错，信息：' . $e->getMessage() . '具体信息请查看日志文件';
            dump('生成报错：' . $n . '错误信息：' . $e->getMessage()
                . $n . '行数：' . $e->getLine()
                . $n . '文件：' . $e->getFile());
        }
     ...
     * @return Response
     */
    public function formField(Request $request): Response
    {
        $param = $request->post();
     ...
     * @return Response
     */
    public function getValidateSelect(Request $request): Response
    {
        $param = $request->all();
        $result = false;
        $data = '';
     ...
     */
    public function getRelationShowField(Request $request): Response
    {
        $param = $request->all();
        $field = $param['field'];
        $name = '';
     ...
     * @throws BindParamException
     */
    public function getRelationTable(Request $request): Response
    {
        $param = $request->all();
        $field = $param['field'];
        $name = '';
