...
class AdminMenuController extends AdminBaseController
{
     ...
     * @return Response
     */
    public function index(AdminMenu $model): Response
    {
     ...
     * @return Response
     */
    public function add(Request $request, AdminMenu $model, AdminMenuValidate $validate): Response
    {
        if ($request->isPost()) {
            $param = $request->all();
     ...
     * @return Response
     */
    public function edit(Request $request, AdminMenu $model, AdminMenuValidate $validate): Response
    {
        /** @var AdminMenu $data */
     ...
     * @return Response
     */
    public function del(AdminMenu $model): Response
    {
