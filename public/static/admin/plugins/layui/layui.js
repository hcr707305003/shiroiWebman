...
!function (p) {
    ...
    var m, d, e, n = p.layui && layui.define, u = {
            ...
            link: function (e, i, t) {
                var n, a, o, s, r, l;
                h.path && (n = document.getElementsByTagName("head")[0], a = document.createElement("link"), o = ((t = "string" == typeof i ? i : t) || e).replace(/\.|\//g, ""), s = "layuicss-" + o, r = "creating", l = 0, a.rel = "stylesheet", a.href = h.path + e, a.id = s, document.getElementById(s) || n.appendChild(a), "function" == typeof i && function c(e) {
                    var t = document.getElementById(s);
                    return 100 < ++l ? p.console && console.error(o + ".css: Invalid") : void (1989 === parseInt(u.getStyle(t, "width")) ? (e === r && t.removeAttribute("lay-status"), t.getAttribute("lay-status") === r ? setTimeout(c, 100) : i()) : (t.setAttribute("lay-status", r), setTimeout(function () {
                        c(r)
                    }, 100)))
                }())
            }
        ...
        i = (y.anim = {
            ...
            var e, t, i, n, a, o = this, s = o.config, r = o.index, l = "object" == typeof (f = s.content),
                c = m("body");
            ...
            switch (s.removeFocus && document.activeElement.blur(), "string" == typeof s.area && (s.area = "auto" === s.area ? ["", ""] : [s.area, ""]), s.shift && (s.anim = s.shift), 6 == h.ie && (s.fixed = !1), s.type) {
                case 0:
                    ...
                    break;
                case 2:
                    var f = s.content = l ? s.content : [s.content || "", "auto"];
                    s.content = '<iframe scrolling="' + (s.content[1] || "auto") + '" allowtransparency="true" id="' + y[4] + r + '" name="' + y[4] + r + '" onload="this.className=\'\';" class="layui-layer-load" frameborder="0" src="' + s.content[0] + '"></iframe>';
                    break;
                case 3:
                    delete s.title, delete s.closeBtn, -1 === s.icon && s.icon, h.closeAll("loading");
                    break;
                case 4:
                    l || (s.content = [s.content, "body"]), s.follow = s.content[1], s.content = s.content[0] + '<i class="layui-layer-TipsG"></i>', delete s.title, s.tips = "object" == typeof s.tips ? s.tips : [s.tips, !0], s.tipsMore || h.closeAll("tips")
            }
            o.vessel(l, function (e, t, i) {
                c.append(e[0]), l ? 2 == s.type || 4 == s.type ? m("body").append(e[1]) : f.parents("." + y[0])[0] || (f.data("display", f.css("display")).show().addClass("layui-layer-wrap").wrap(e[1]), m("#" + y[0] + r).find("." + y[5]).before(t)) : c.append(e[1]), m("#" + y.MOVE)[0] || c.append(u.moveElem = i), o.layero = m("#" + y[0] + r), o.shadeo = m("#" + y.SHADE + r), s.scrollbar || u.setScrollbar(r)
            }).auto(r), o.shadeo.css({
            ...
            return a.move && t.css("cursor", "move"), t.on("mousedown", function (e) {
                var t, i;
                e.button || (t = m(this), i = {}, a.move && (i.layero = o, i.config = a, i.offset = [e.clientX - parseFloat(o.css("left")), e.clientY - parseFloat(o.css("top"))], t.data(l[0], i), u.eventMoveElem = t, u.moveElem.css("cursor", "move").show()), e.preventDefault())
            }), i.on("mousedown", function (e) {
                var t = m(this), i = {};
                a.resize && (i.layero = o, i.config = a, i.offset = [e.clientX, e.clientY], i.index = n.index, i.area = [o.outerWidth(), o.outerHeight()], t.data(l[1], i), u.eventResizeElem = t, u.moveElem.css("cursor", "se-resize").show()), e.preventDefault()
            }), u.docEvent || (e.on("mousemove", function (e) {
                var t, i, n, a, o, s, r;
                u.eventMoveElem && (t = (a = u.eventMoveElem.data(l[0]) || {}).layero, o = a.config, s = e.clientX - a.offset[0], r = e.clientY - a.offset[1], i = "fixed" === t.css("position"), e.preventDefault(), a.stX = i ? 0 : d.scrollLeft(), a.stY = i ? 0 : d.scrollTop(), o.moveOut || (i = d.width() - t.outerWidth() + a.stX, n = d.height() - t.outerHeight() + a.stY, i < (s = s < a.stX ? a.stX : s) && (s = i), n < (r = r < a.stY ? a.stY : r) && (r = n)), t.css({
                    left: s,
                    top: r
                })), u.eventResizeElem && (o = (a = u.eventResizeElem.data(l[1]) || {}).config, s = e.clientX - a.offset[0], r = e.clientY - a.offset[1], e.preventDefault(), h.style(a.index, {
                    width: a.area[0] + s,
                    height: a.area[1] + r
                }), o.resizing && o.resizing(a.layero))
            }).on("mouseup", function (e) {
                var t, i;
                u.eventMoveElem && (i = (t = u.eventMoveElem.data(l[0]) || {}).config, u.eventMoveElem.removeData(l[0]), delete u.eventMoveElem, u.moveElem.hide(), i.moveEnd && i.moveEnd(t.layero)), u.eventResizeElem && (u.eventResizeElem.removeData(l[1]), delete u.eventResizeElem, u.moveElem.hide())
            }), u.docEvent = !0), n
            ...
            var i, n, a, o, s, r, l = m("#" + y[0] + e), c = l.data("maxminStatus");
            "min" !== c && ("max" === c && h.restore(e), l.data("maxminStatus", "min"), t = t || l.data("config") || {}, c = m("#" + y.SHADE + e), i = l.find(".layui-layer-min"), n = l.find(y[1]).outerHeight() || 0, o = (a = "string" == typeof (o = l.attr("minLeft"))) ? o : 181 * u.minStackIndex + "px", s = l.css("position"), r = {
                width: 180,
                height: n,
                position: "fixed",
                overflow: "hidden"
            }, u.record(l), 0 < u.minStackArr.length && (o = u.minStackArr[0], u.minStackArr.shift()), parseFloat(o) + 180 > d.width() && (o = d.width() - 180 - (u.minStackArr.edgeIndex = u.minStackArr.edgeIndex || 0, u.minStackArr.edgeIndex += 3)) < 0 && (o = 0), t.minStack && (r.left = o, r.top = d.height() - n, a || u.minStackIndex++, l.attr("minLeft", o)), l.attr("position", s), h.style(e, r, !0), i.hide(), "page" === l.attr("type") && l.find(y[4]).hide(), u.restScrollbar(e), c.hide())
            ...
            var r, e,
                l = (t = m("." + y[0]).children("#" + o).closest("." + y[0]))[0] ? (o = t.attr("times"), t) : m("#" + y[0] + o),
                c = l.attr("type"), t = l.data("config") || {}, f = t.id && t.hideOnClose;
            l[0] && (r = {
                ...
                if (c === u.type[1] && "object" === l.attr("conType")) {
                    l.children(":not(." + y[5] + ")").remove();
                    for (var t = l.find("." + e), i = 0; i < 2; i++) t.unwrap();
                    t.css("display", t.data("display")).removeClass(e)
                } else {
                    if (c === u.type[2]) try {
                        var n = m("#" + y[4] + o)[0];
                        n.contentWindow.document.write(""), n.contentWindow.close(), l.find("." + y[5])[0].removeChild(n)
                    } catch (a) {
                    }
            ...
            }, m("#" + y.SHADE + o)[f ? "hide" : "remove"](), t.isOutAnim && l.addClass("layer-anim " + r), 6 == h.ie && u.reselect(), u.restScrollbar(o), "string" == typeof l.attr("minLeft") && (u.minStackIndex--, u.minStackArr.push(l.attr("minLeft"))), h.ie && h.ie < 10 || !t.isOutAnim ? e() : setTimeout(function () {
                e()
            }, 200))
    ...
    h.prompt = function (i, n) {
        ...
        if ((n = m.extend(!0, {toolbar: !0, footer: !0}, n)).photos) {
            ...
            if (o.imgIndex = 1 + (0 | r), n.img = n.img || "img", delete n.success, t) {
            ...
            var t = s[r].src, d = function (e) {
                ...
                a && (n.anim = -1), o.index = h.open(m.extend({
                    ...
                    content: '<div class="layer-layer-photos-main"><img src="' + s[r].src + '" alt="' + i + '" layer-pid="' + (s[r].pid || "") + '">' + (t = ['<div class="layui-layer-photos-pointer">'], 1 < s.length && t.push(['<div class="layer-layer-photos-page">', '<span class="layui-icon layui-icon-left layui-layer-photos-prev"></span>', '<span class="layui-icon layui-icon-right layui-layer-photos-next"></span>', "</div>"].join("")), n.toolbar && t.push(['<div class="layui-layer-photos-toolbar layui-layer-photos-header">', '<span toolbar-event="rotate" data-option="90" title="\u65cb\u8f6c"><i class="layui-icon layui-icon-refresh"></i></span>', '<span toolbar-event="scalex" title="\u53d8\u6362"><i class="layui-icon layui-icon-slider"></i></span>', '<span toolbar-event="zoom" data-option="0.1" title="\u653e\u5927"><i class="layui-icon layui-icon-add-circle"></i></span>', '<span toolbar-event="zoom" data-option="-0.1" title="\u7f29\u5c0f"><i class="layui-icon layui-icon-reduce-circle"></i></span>', '<span toolbar-event="reset" title="\u8fd8\u539f"><i class="layui-icon layui-icon-refresh-1"></i></span>', '<span toolbar-event="close" title="\u5173\u95ed"><i class="layui-icon layui-icon-close"></i></span>', "</div>"].join("")), n.footer && t.push(['<div class="layui-layer-photos-toolbar layui-layer-photos-footer">', "<h3>" + i + "</h3>", "<em>" + o.imgIndex + " / " + s.length + "</em>", '<a href="' + s[r].src + '" target="_blank">\u67e5\u770b\u539f\u56fe</a>', "</div>"].join("")), t.push("</div>"), t.join("")) + "</div>",
                    success: function (e, t, i) {
                        o.main = e.find(".layer-layer-photos-main"), o.footer = e.find(".layui-layer-photos-footer"), o.imgElem = o.main.children("img"), o.event(e, t, i), n.tab && n.tab(s[r], e), "function" == typeof l && l(e)
                    },
                    end: function () {
...
layui.define("jquery", function (t) {
    ...
    var s = layui.$, p = layui.hint(), o = {
        fixbar: function (i) {
            var o, t, e, n, r = "layui-fixbar", a = s(document), u = (i = s.extend(!0, {
                    target: "body",
                    bars: [],
                    "default": !0,
                    margin: 160,
            ...
            }), u.find("." + r).remove(), "object" == typeof i.css && l.css(i.css), u.append(l), o && (e = function e() {
                return c.scrollTop() >= i.margin ? t || (o.show(), t = 1) : t && (o.hide(), t = 0), e
            ...
            var o = arguments, r = (1 < o.length && (i.date = new Date(o[0]), i.now = new Date(o[1]), i.clock = o[2]), {
                ...
                }, 1e3), "function" == typeof i.clock && i.clock(n, r), t <= 0 && (clearTimeout(r.timer), "function" == typeof i.done && i.done(n, r)), u
            }());
            return r
            ...
            if (null === t || "" === t) return "";
            var i = this, o = new Date(function () {
                if (t) return !isNaN(t) && "string" == typeof t ? parseInt(t) : t
            }() || new Date);
            if (!o.getDate()) return p.error('Invalid millisecond for "util.toDateString(millisecond)"'), "";
            var r = o.getFullYear(), a = o.getMonth(), u = o.getDate(), c = o.getHours(), l = o.getMinutes(),
                s = o.getSeconds(), f = o.getMilliseconds(), d = n && n.customMeridiem || function (t, e) {
                    t = 100 * t + e;
            ...
            (t = s.extend({
                ...
                duration: 200,
                type: "y"
            }, t)).scrollElem[0] && t.thisElem[0] && (e = t.scrollElem, u = t.thisElem, i = (r = "y" === t.type) ? "top" : "left", o = e[n = r ? "scrollTop" : "scrollLeft"](), r = e[r ? "height" : "width"](), a = e.offset()[i], c = {}, ((u = u.offset()[i] - a) > r - t.margin || u < t.margin) && (c[n] = u - r / 2 + o, e.animate(c, t.duration)))
...
layui.define(["jquery", "laytpl", "lay", "util"], function (e) {
    ...
    var n, i, t, c = layui.$, m = layui.laytpl, p = layui.util, a = layui.hint(),
        ...
        C = "layui-dropdown-shade", k = "." + u + ">." + v, E = function (e) {
            var i = this;
    ...
    E.prototype.config = {
        ...
        var l = this, d = l.config, u = d.customName, t = c("body"), n = function () {
                ...
                return 0 < d.data.length ? s(e, d.data) : e.html('<li class="layui-menu-item-none">暂无数据</li>'), e
            }, s = function (r, e) {
        ...
        !(e = "contextmenu" !== d.trigger && !lay.isTopElem(d.elem[0]) ? e : !0) && d.elem.data(y + "_opened") || (l.elemView = c("." + g + '[lay-id="' + d.id + '"]'), "reloadData" === i && l.elemView.length ? l.elemView.html(d.content || n()) : (l.elemView = c(a), l.elemView.append(d.content || n()), d.className && l.elemView.addClass(d.className), d.style && l.elemView.attr("style", d.style), h.thisId = d.id, l.remove(), t.append(l.elemView), d.elem.data(y + "_opened", !0), e = d.shade ? '<div class="' + C + '" style="z-index:' + (l.elemView.css("z-index") - 1) + "; background-color: " + (d.shade[1] || "#000") + "; opacity: " + (d.shade[0] || d.shade) + '"></div>' : "", l.elemView.before(e), "mouseenter" === d.trigger && l.elemView.on("mouseenter", function () {
            ...
            var i = c(this), t = i.data("item") || {}, n = !d.isParentClick && t[u.children] && 0 < t[u.children].length,
                a = "all" === d.clickScope;
            if (t.level==1 && !d.isFirstClick){
                n=true;
            }
            // console.log("=======----=",n)
            // d.click(t, i)
        ...
        this.config;
        var e = f.prevElem;
        e && (e.data("prevElem") && e.data("prevElem").data(y + "_opened", !1), e.remove()), lay("." + C).remove()
        ...
        var t = e.hasClass(l), n = function (e, i) {
            var t = e.children("ul"), n = t[0].scrollHeight;
            t.is(":animated") || (e.removeClass(i ? l : d).addClass(i ? d : l), t.height(i ? 0 : n).stop().animate({
                opacity: i ? 1 : 0,
                height: i ? n : 0
            }, 200, function () {
        ...
        n(e, t), t && i && layui.each(e.siblings("." + d), function (e, i) {
            n(c(i), !1)
        })
        ...
        i.hasClass("layui-menu-item-divider") || n || (t.find("." + s).removeClass(s), t.find("." + V).removeClass(V), i.addClass(s), i.parents("." + w).addClass(V), l.title = l.title || c.trim(i.children("." + v).text()), layui.event.call(this, r, "click(" + a + ")", l))
    }), i.on("click", t + k, function (e) {
        var i = c(this), t = i.parents("." + u + ":eq(0)"), n = lay.options(t[0]),
...
layui.define("jquery", function (t) {
    ...
    var u = layui.$, d = (layui.hint(), layui.device()), c = "element", r = "layui-this", h = "layui-show",
        ...
        v = "layui-nav-more", m = "layui-anim layui-anim-upbit", g = {
            tabClick: function (t) {
                ...
                i.hasClass(r) && (i.next()[0] && i.next().is("li") ? g.tabClick.call(i.next()[0], {index: a + 1}) : i.prev()[0] && i.prev().is("li") && g.tabClick.call(i.prev()[0], null, a - 1)), i.remove(), l.eq(a).remove(), setTimeout(function () {
                    g.tabAuto()
                ...
                if ("javascript:;" !== t.attr("href") && "_blank" === t.attr("target") || n || l[0] || (i.find("." + r).removeClass(r), e.addClass(r)), i.hasClass(p)) {
                    var s = f + "ed", n = "layui-nav-expand", o = !(e.hasClass(n) || e.hasClass(s));
                    if (l.is(":animated")) return;
                    l.removeClass(m), l[0] && (l.stop().slideToggle(200, function () {
                        o || e.removeClass(s)
                    }), e[o ? "addClass" : "removeClass"](n), "string" != typeof i.attr("lay-accordion") && "all" !== i.attr("lay-shrink") || e.siblings().removeClass([s, n].join(" ")).children("." + b).stop().slideUp(200))
                }
    ...
    u(function () {
        a.render()
    }), e.on("click", ".layui-tab-title li", g.tabClick), u(window).on("resize", g.tabAuto), t(c, a)
});
                ...
                input: function (e) {
                    var e = e || a.find("input,textarea"),
                        t = (i.autocomplete && e.attr("autocomplete", i.autocomplete), function (e, t) {
                            ...
                            }, s = 0 <= s ? s : Math.max(t(n), t(i)), o || (r <= (a = a <= l ? l : a) && (a = r), s && (a = a.toFixed(s)), e.val(a)), (n = {
                    ...
                    var p, c = "\u8bf7\u9009\u62e9", m = "layui-form-select", x = "layui-select-title",
                        g = "layui-select-none", b = "", e = e || a.find("select"), k = function (e, t) {
                            C(e.target).parent().hasClass(x) && !t || (C("." + m).removeClass(m + "ed " + m + "up"), p && b && p.val(b)), p = null
                        }, u = function (a, e, t) {
                            var s, r, i, n, o, l, c = C(this), u = a.find("." + x), d = u.find("input"), f = a.find("dl"),
                            ...
                            e || (r = c.attr("lay-search"), i = function () {
                                ...
                                a.hasClass(m + "ed") ? n() : (k(e, !0), i()), f.find("." + g).remove()
                                ...
                                l(t, function (e) {
                                    e ? f.find("." + g)[0] || f.append('<p class="' + g + '">\u65e0\u5339\u914d\u9879</p>') : f.find("." + g).remove()
                                }, "keyup"), "" === t && (c.val(""), f.find("." + N).removeClass(N), (c[0].options[0] || {}).value || f.children("dd:eq(0)").addClass(N), f.find("." + g).remove()), o()
                            }).on("blur", function (e) {
                                var t = c[0].selectedIndex;
                    ...
                    e.each(function (e, t) {
                        ...
                        var s, o = "string" == typeof i.attr("lay-search"), t = t && !t.value && t.innerHTML || c,
                            r = C(['<div class="' + (o ? "" : "layui-unselect ") + m, (n ? " layui-select-disabled" : "") + '">', '<div class="' + x + '">', '<input type="text" placeholder="' + d.escape(C.trim(t)) + '" value="' + d.escape(C.trim(l ? r.html() : "")) + '"' + (!n && o ? "" : " readonly") + ' class="layui-input' + (o ? "" : " layui-unselect") + (n ? " " + $ : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (i.find("optgroup")[0] ? " layui-select-group" : "") + '">', (t = i.find("*"), s = [], layui.each(t, function (e, t) {
                                var i = t.tagName.toLowerCase();
                                0 !== e || t.value || "optgroup" === i ? "optgroup" === i ? s.push("<dt>" + t.label + "</dt>") : s.push('<dd lay-value="' + d.escape(t.value) + '" class="' + (l === t.value ? N : "") + (t.disabled ? " " + $ : "") + '">' + C.trim(t.innerHTML) + "</dd>") : s.push('<dd lay-value="" class="layui-select-tips">' + C.trim(t.innerHTML || c) + "</dd>")
...
layui.define(["table"], function (e) {
    ...
    var d, U = function (e, t, a) {
        ...
        a.hasClass(h) && (a = F(t), o(e), u.call(a, e.tr, e.checked))
    ...
    P.on("checkbox", function (e) {
        var t = e.config, a = t.elem.next(), t = t.id;
        a.hasClass(h) && (a = F(t), t = e.checked, o(e), e.isAll = u.call(a, e.tr, t))
    }), P.setRowChecked = function (a, e) {
        var t, n, i, l, r, d, o, c = F(a);
        c && (t = c.getOptions().elem.next(), i = (e = e || {}).index, n = e.checked, e = e.callbackFlag, i = "string" === layui.type(i) ? i : i[H], (d = c.getNodeDataByIndex(i)) && (l = function (e) {
            o.push(e), t.find('tr[lay-data-index="' + e + '"]').length || (e = c.getNodeDataByIndex(e)[s]) && l(e)
        }, (r = t.find('tr[lay-data-index="' + i + '"]')).length || (d = d[s], o = [], l(d), layui.each(o.reverse(), function (e, t) {
            P.expandNode(a, {index: t, expandFlag: !0})
        }), r = t.find('tr[lay-data-index="' + i + '"]')), u.call(c, r, n, e)))
    ...
    l.prototype.config = {
        ...
        layui.each(e, function (e, i) {
            var a = i[d.children] && 0 < i[d.children].length,
                ...
                t = p(['<div data-id="' + i[d.id] + '" class="layui-tree-set' + (i.spread ? " layui-tree-spread" : "") + (i.checked ? " layui-tree-checkedFirst" : "") + '">', '<div class="layui-tree-entry">', '<div class="layui-tree-main">', r.showLine ? a ? '<span class="layui-tree-iconClick layui-tree-icon"><i class="layui-icon ' + (i.spread ? "layui-icon-subtraction" : "layui-icon-addition") + '"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-icon layui-icon-file"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-tree-iconArrow ' + (a ? "" : f) + '"></i></span>', r.showCheckbox ? '<input type="checkbox" name="' + (i.field || "layuiTreeCheck_" + i[d.id]) + '" same="layuiTreeCheck" lay-skin="primary" ' + (i.disabled ? "disabled" : "") + ' value="' + i[d.id] + '">' : "", r.isJump && i.href ? '<a href="' + i.href + '" target="_blank" class="' + g + '">' + (i[d.title] || i.label || r.text.defaultNodeName) + "</a>" : '<span data-index="'+i.obligatory_status+'" class="' + g + (i.disabled ? " " + o : "") +(i.type==2 ? " layui-tree-txt2" : "") +'">'+(r.showId?"(id:"+i[d.id]+") ":"") + (i[d.title] || i.label || r.text.defaultNodeName)+(!i.obligatory_status&&i.type==2?'(选修)':'') + "</span>", "</div>", function () {
                    if (!r.edit) return "";
                    var a = {
...
layui.define(["lay", "util", "element", "form"], function (e) {
    ...
    e("code", function (l, e) {
        ...
        if (1 < a.length) return layui.each(l.obverse ? a : a.get().reverse(), function () {
            layui.code(x.extend({}, l, {elem: this}), e)
        }), t;
        var i, o, n = l.elem = x(l.elem);
        if (!n[0]) return t;
        x.extend(!0, l, lay.options(n[0]), (i = {}, layui.each(["title", "height", "encode", "skin", "about"], function (e, t) {
            var a = n.attr("lay-" + t);
            "string" == typeof a && (i[t] = a)
        }), i)), l.encode = (l.encode || l.preview) && !l.codeRender, l.code = l.code || (o = [], n.children("textarea").each(function () {
            o.push(R(this.value))
        }), 0 === o.length && o.push(R(n.html())), o.join(""));
        var a = function (e) {
        ...
        }, d = l.code, c = function (e) {
            return "function" == typeof l.codeParse ? l.codeParse(e, l) : e
        };
        if ("reloadCode" === e) return n.children(".layui-code-wrap").html(a(c(d)).html), t;
        var s, r, u, y, p, E, f = layui.code.index = ++W,
            h = (n.attr("lay-code-index", f), A.CDDE_DATA_CLASS in n.data()),
            v = (h && n.attr("class", n.data(A.CDDE_DATA_CLASS) || ""), h || n.data(A.CDDE_DATA_CLASS, n.attr("class")), {
                copy: {
                    className: "file-b",
                    title: ["\u590d\u5236\u4ee3\u7801"],
                    event: function (e) {
                        var t = D.unescape(c(l.code));
                ...
                var e = n.parent("." + A.ELEM_PREVIEW), t = e.children("." + A.ELEM_TAB),
                    a = e.children("." + A.ELEM_ITEM + "-preview");
                return t.remove(), a.remove(), e[0] && n.unwrap(), b
            }(), l.preview && (h = "LAY-CODE-DF-" + f, _ = l.layout || ["code", "preview"], s = "iframe" === l.preview, p = x('<div class="' + A.ELEM_PREVIEW + '">'), L = x('<div class="layui-tab layui-tab-brief">'), r = x('<div class="layui-tab-title">'), E = x('<div class="' + [A.ELEM_ITEM, A.ELEM_ITEM + "-preview", "layui-border"].join(" ") + '">'), u = x('<div class="layui-code-tools"></div>'), l.id && p.attr("id", l.id), p.addClass(l.className), L.attr("lay-filter", h), layui.each(_, function (e, t) {
                var a = x('<li lay-id="' + t + '">');
                ...
                var e = x(this), t = e.data("type"),
                    e = {elem: e, type: t, options: l, rawCode: l.code, finalCode: D.unescape(c(l.code))};
                v[t] && "function" == typeof v[t].event && v[t].event(e), "function" == typeof l.toolsEvent && l.toolsEvent(e)
            }), l.addTools && l.tools && (l.tools = [].concat(l.tools, l.addTools)), layui.each(l.tools, function (e, t) {
                var a = "object" == typeof t, i = a ? t : v[t] || {className: t, title: [t]}, l = i.className || i.type,
                    o = i.title || [""], a = a ? i.type || l : t;
                a && (v[a] || ((t = {})[a] = i, x.extend(v, t)), u.append('<i class="layui-icon layui-icon-' + l + '" data-type="' + a + '" title="' + o[0] + '"></i>'))
            }), n.addClass(A.ELEM_ITEM).wrap(p), L.append(r), l.tools && L.append(u), n.before(L), s && E.html('<iframe allowtransparency="true" frameborder="0"></iframe>'), y = function (e) {
                var t = e.children("iframe")[0];
                s && t ? t.srcdoc = c(l.code) : e.html(l.code), setTimeout(function () {
            ...
            }, "preview" === _[0] ? (E.addClass(A.ELEM_SHOW), n.before(E), y(E)) : n.addClass(A.ELEM_SHOW).after(E), l.previewStyle = [l.style, l.previewStyle].join(""), E.attr("style", l.previewStyle), S.on("tab(" + h + ")", function (e) {
                var t = x(this), a = x(e.elem).closest("." + A.ELEM_PREVIEW).find("." + A.ELEM_ITEM), e = a.eq(e.index);
                a.removeClass(A.ELEM_SHOW), e.addClass(A.ELEM_SHOW), "preview" === t.attr("lay-id") && y(e), w()
            })), x('<code class="layui-code-wrap"></code>')),
            L = (n.addClass((p = ["layui-code-view layui-border-box"], l.wordWrap || p.push("layui-code-nowrap"), p.join(" "))), l.theme || l.skin),
            _ = (L && (n.removeClass("layui-code-theme-dark layui-code-theme-light"), n.addClass("layui-code-theme-" + L)), l.highlighter && n.addClass([l.highlighter, "language-" + l.lang, "layui-code-hl"].join(" ")), a(l.encode ? D.escape(c(d)) : d)),
            M = _.lines,
            C = (n.html(m.html(_.html)), l.ln && n.append('<div class="layui-code-ln-side"></div>'), l.height && m.css("max-height", l.height), l.codeStyle = [l.style, l.codeStyle].join(""), l.codeStyle && m.attr("style", function (e, t) {
                ...
                target: n[0], id: "DF-code-" + f, text: x.map(x.map(C, function (e) {
                    return e.selector
                }), function (e, t) {
                ...
                var e, i;
                return l.ln && (e = Math.floor(M.length / 100), i = m.children("." + A.ELEM_LINE).last().children("." + A.ELEM_LINE_NUM).outerWidth(), n.addClass(A.ELEM_LN_MODE), e && i > A.LINE_RAW_WIDTH && lay.getStyleRules(g, function (e, t) {
                    try {
                        C[t].setValue(e, i)
                    } catch (a) {
                    }
            ...
            h = (l.header && ((E = x('<div class="' + A.ELEM_HEADER + '"></div>')).html(l.title || l.text.code), n.prepend(E)), x('<div class="layui-code-fixbar"></div>'));
        return l.copy && !l.preview && ((L = x(['<span class="layui-code-copy">', '<i class="layui-icon layui-icon-file-b" title="\u590d\u5236"></i>', "</span>"].join(""))).on("click", function () {
            v.copy.event()
        }), h.append(L)), l.langMarker && h.append('<span class="layui-code-lang-marker">' + l.lang + "</span>"), l.about && h.append(l.about), n.append(h), l.preview || setTimeout(function () {
            "function" == typeof l.done && l.done({})
        }, 3), l.elem.length === 1 + f && "function" == typeof l.allDone && l.allDone(), t
    })
